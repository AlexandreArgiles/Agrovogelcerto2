  ...
  return (
    <div className="animate-in fade-in duration-500">
      <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center mb-6">
        ...
        <button onClick={() => setIsModalOpen(true)} className="w-full sm:w-auto bg-[#8cc63f] text-[#0a5c36] font-bold px-4 py-2.5 rounded-lg flex items-center justify-center shadow-sm">
